/* biome-ignore-all lint/a11y/useSemanticElements: Registry Field uses a generic grouped container rather than fieldset semantics for each individual control. */
